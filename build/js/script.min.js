(() => {
  ...
  var require_autosize_min = __commonJS({
    "node_modules/autosize/dist/autosize.min.js"(exports, module) {
      !(function(e2, t2) {
        "object" == typeof exports && "undefined" != typeof module ? module.exports = t2() : "function" == typeof define && define.amd ? define(t2) : (e2 || self).autosize = t2();
      })(exports, function() {
        ...
        var r2 = null;
        return "undefined" == typeof window ? ((r2 = function(e3) {
          return e3;
        }).destroy = function(e3) {
          return e3;
          ...
          return t3 && Array.prototype.forEach.call(t3.length ? t3 : [t3], function(t4) {
            return (function(t5) {
              if (t5 && t5.nodeName && "TEXTAREA" === t5.nodeName && !e2.has(t5)) {
                var o4, r3 = null, n2 = window.getComputedStyle(t5), i = (o4 = t5.value, function() {
                  s({ testForHeightReduction: "" === o4 || !t5.value.startsWith(o4), restoreTextAlign: null }), o4 = t5.value;
                }), l = function(o5) {
                  t5.removeEventListener("autosize:destroy", l), t5.removeEventListener("autosize:update", a), t5.removeEventListener("input", i), window.removeEventListener("resize", a), Object.keys(o5).forEach(function(e3) {
                ...
                t5.addEventListener("autosize:destroy", l), t5.addEventListener("autosize:update", a), t5.addEventListener("input", i), window.addEventListener("resize", a), t5.style.overflowX = "hidden", t5.style.wordWrap = "break-word", e2.set(t5, { destroy: l, update: a }), a();
              }
              function s(e3) {
                var o5, i2, l2 = e3.restoreTextAlign, a2 = void 0 === l2 ? null : l2, d = e3.testForHeightReduction, u = void 0 === d || d, f = n2.overflowY;
                if (0 !== t5.scrollHeight && ("vertical" === n2.resize ? t5.style.resize = "none" : "both" === n2.resize && (t5.style.resize = "horizontal"), u && (o5 = (function(e4) {
                ...
                })(t5), t5.style.height = ""), i2 = "content-box" === n2.boxSizing ? t5.scrollHeight - (parseFloat(n2.paddingTop) + parseFloat(n2.paddingBottom)) : t5.scrollHeight + parseFloat(n2.borderTopWidth) + parseFloat(n2.borderBottomWidth), "none" !== n2.maxHeight && i2 > parseFloat(n2.maxHeight) ? ("hidden" === n2.overflowY && (t5.style.overflow = "scroll"), i2 = parseFloat(n2.maxHeight)) : "hidden" !== n2.overflowY && (t5.style.overflow = "hidden"), t5.style.height = i2 + "px", a2 && (t5.style.textAlign = a2), o5 && o5(), r3 !== i2 && (t5.dispatchEvent(new Event("autosize:resized", { bubbles: true })), r3 = i2), f !== n2.overflow && !a2)) {
                  var c = n2.textAlign;
                  "hidden" === n2.overflow && (t5.style.textAlign = "start" === c ? "end" : "start"), s({ restoreTextAlign: c, testForHeightReduction: true });
                }
              }
              function a() {
                s({ testForHeightReduction: true, restoreTextAlign: null });
              }
            })(t4);
          }), t3;
        }).destroy = function(e3) {
  ...
  function loadBackgroundImage(element, fastScroll) {
    ...
    var bgImage = isWebpSupported ? element.getAttribute("data-bg-webp") : element.getAttribute("data-bg");
    if (!bgImage) return;
  ...
  function initThemeSwitcher() {
    ...
    window.addEventListener("storage", function(e2) {
      if (e2.key === STORAGE_KEY) {
        lastToggleTime = Date.now();
        if (e2.newValue === null) {
          setThemeAttribute(prefersDark.matches ? "dark" : "light", true);
        } else if (e2.newValue === "dark" || e2.newValue === "light") {
          setThemeAttribute(e2.newValue, true);
        }
      }
    });
    function initDOM() {
  ...
  // src/blocks/field-actions/field-actions.js
  (function() {
    ...
    for (let i = 0; i < agreementElems.length; i++) {
      ...
      if (agreementCheckbox) {
        agreementCheckbox.addEventListener("change", function(e2) {
  ...
  function initFieldText() {
    ...
    autosize_esm_default(textareas);
  }
  initFieldText();
  ...
  (function() {
    ...
    if (toggler) {
      let mainNavVisibleToggle = function(e2) {
        e2.preventDefault();
    ...
    Element.prototype.parents = function(selector) {
      var elements = [];
      var elem = this;
      var ishaveselector = selector !== void 0;
  ...
  // src/blocks/test-block/test-block.js
  (function() {
